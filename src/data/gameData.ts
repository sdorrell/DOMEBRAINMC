...
// ─── DOME BADGES ─────────────────────────────────────────────────────────────
// Day-1 tier: earnable immediately. Long-term tier: aspirational milestones.
...
export const BADGES: Badge[] = [
  ...
  },
  {
    ...
    name: 'First Steps',
    emoji: '👟',
    descriptor: 'Logged your first session into DOME Mission Control. The journey begins.',
    category: 'grind',
    isTemporary: false,
    requirement: 'First login to Mission Control',
    rarity: 'common',
  },
  {
    id: 'spark',
    name: 'Spark',
    emoji: '✨',
    descriptor: 'Submitted your first idea. It came from somewhere in your brain. Probably.',
    category: 'social',
    isTemporary: false,
    requirement: 'Submit 1 idea',
    rarity: 'common',
  },
  {
    id: 'voter',
    name: 'Voter',
    emoji: '🗳️',
    descriptor: 'Cast your first upvote on a teammate\'s idea. Democracy begins with you.',
    category: 'social',
    isTemporary: false,
    requirement: 'Cast 1 upvote',
    rarity: 'common',
  },
  {
    id: 'first_blood',
    name: 'First Blood',
    emoji: '⚔️',
    descriptor: 'Won your first Arena battle. The crowd goes mild.',
    category: 'grind',
    isTemporary: false,
    requirement: 'Win 1 Arena battle',
    rarity: 'common',
  },
  {
    id: 'request_filed',
    name: 'Request Filed',
    emoji: '📋',
    descriptor: 'Submitted your first update request. You have opinions. We respect that.',
    category: 'social',
    isTemporary: false,
    requirement: 'Submit 1 update request',
    rarity: 'common',
  },
  {
    id: 'brain_initiate',
    name: 'Brain Initiate',
    emoji: '🧠',
    descriptor: 'Logged your first work summary into DOME Brain. Your thoughts are now on record.',
    category: 'brain',
    isTemporary: false,
    requirement: '1 work summary logged',
    rarity: 'common',
  },
  {
    id: 'word_smith',
    name: 'Word Smith',
    emoji: '📖',
    descriptor: 'Added your first term to the DOME glossary. You are defining the culture.',
    category: 'brain',
    isTemporary: false,
    requirement: 'Add 1 glossary term',
    rarity: 'common',
  },
  // ── Long-term / Milestone ─────────────────────────────────────────────────
  {
